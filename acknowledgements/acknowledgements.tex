...
Other \genus~employees that deserve recognition includes \textit{Thomas Hedén}, which demonstrated \qlikview~to me and helped me access customer data, \textit{Bernt Almlid} that held a lesson in \genusSoftware~multitenancy and architecture, and \textit{Martin Børke} for input on the history of \bi.
