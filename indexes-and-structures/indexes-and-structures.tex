...
\missingfigure{Add a figure from \cite{Schwalb2014-hn} that shows how an inverted index can be implemented efficiently in a read only store}
...
\missingfigure{Insert figure from \cite{Bjorklund2011-wh} on WAH compression}
