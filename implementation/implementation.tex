...
The absence of loop pipelining can have dramatic effects on query performance. Boncz \ea~\cite{Boncz2005} show how the \mysql uses 49 cycles per tuple due to the absence of loop pipelining.
